...
class Wp_Book {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'bkmeta_integrate_wpdb', 0 );
		$this->loader->add_action( 'init', $plugin_admin, 'bk_create_cpt' );
		$this->loader->add_action( 'init', $plugin_admin, 'bk_create_ht' );
		$this->loader->add_action( 'init', $plugin_admin, 'bk_create_nht' );
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'bk_create_meta_box' );
		$this->loader->add_action( 'save_post', $plugin_admin, 'bk_save_table', 10, 2  );
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'bk_submenu_settings' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'bk_submenu_settings_init' );
		$this->loader->add_action( 'widget_init', $plugin_admin, 'bk_register_sidebar' );
		$this->loader->add_action( 'widget_init', $plugin_admin, 'init' );
		$this->loader->add_action( 'wp_dashboard_setup', $plugin_admin, 'bk_dashboard_widget' );
